import { TelnetCommands } from './types.js';
/**
 * Telnet 프로토콜 핸들러
 ...
 */
export function processIAC(data) {
    const cleanData = [];
    const iacSequences = [];
    let i = 0;
    while (i < data.length) {
 ...
 * @returns 응답 버퍼
 */
export function negotiateOption(command, option) {
    const response = [TelnetCommands.IAC];
 ...
 */
export function handleTelnetProtocol(data) {
...
//# sourceMappingURL=telnetProtocol.js.map